...
type Engine struct{cfg *config.Config;cfgMu sync.RWMutex;tracker *ConnTracker;tproxy *TProxy;interceptor *Interceptor;udpBlocker *UDPBlocker;ipv6Blocker *IPv6Blocker;Stats *Stats}
...
func(e *Engine)Stop(){if e.ipv6Blocker!=nil{e.ipv6Blocker.Close()};if e.udpBlocker!=nil{e.udpBlocker.Close()};if e.interceptor!=nil{e.interceptor.Close()};if e.tproxy!=nil{_=e.tproxy.Close()};if e.tracker!=nil{e.tracker.Close()};CleanUpOnShutdown()}
