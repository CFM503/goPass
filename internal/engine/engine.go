...
type Engine struct{cfg *config.Config;cfgMu sync.RWMutex;tracker *ConnTrack; tproxy *TProxy;interceptor *Interceptor;udpBlocker *UDPBlocker;Stats *Stats}
