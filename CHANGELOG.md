...
- **设置页精简**：保留上游代理和 TProxy Buffer Size；Buffer 可选 32 KB、64 KB、128 KB、256 KB、512 KB、1 MB，默认 256 KB，运行时上限 1 MB。
- **其他 TCP 调优不开放**：TCP NoDelay、Keep-Alive、Linger 等参数不作为 Web UI 设置项。
